...
module.exports = {
  name: 'anti-toxicity',
  description: "Setup or disable anti toxicity.",
  ...
  options: [
    {
      ...
      choices: [
        {
          name: "Setup/Configure anti toxicity.",
          value: "st_con"
        },
        {
          "name": "Disable anti toxicity.",
          "value": "disable"
        }
      ],
    }
      ...
      switch (choice) {
        case "st_con":
          ...
          const messageEmbed = new EmbedBuilder()
            .setColor(0xFF0000)
            .setTitle('Setup Anti Toxicity (step 1 of 1)')
          ...
          collector2.on('collect', async i => {
            ...
            DB.findOne({ Guild: interaction.guild.id }, async (err, data) => {
              ...
              const messageEmbed2 = new EmbedBuilder()
                .setColor(0xFF0000)
                .setTitle('Anti Toxicity (Optional 1 of 2)')
                .setDescription(`Please select a user that is whitelisted from the Anti Toxicity system.\n\n**THIS IS OPTIONAL!**`)

              const row3 = new ActionRowBuilder()
                .addComponents(
                  new UserSelectMenuBuilder({
                    custom_id: 'user_ignored_toxicity',
          ...
          collector3.on('collect', async i => {
            ...
            const messageEmbed3 = new EmbedBuilder()
              .setColor(0xFF0000)
              .setTitle('Anti Toxicity (Optional 2 of 2)')
            ...
            messageEmbed3.setDescription(`User(s): ${miniArray.join(`,`)}\n\nPlease select a role that is whitelisted from sending toxic messages.\n**THIS IS OPTIONAL**`)
            ...
            const row4 = new ActionRowBuilder()
              .addComponents(
                new RoleSelectMenuBuilder({
                  custom_id: 'role_select_anti_toxicicity',
          ...
          collector4.on('collect', async i => {
            ...
            if (myRole.position > interaction.guild.members.me.roles.highest.position) {
              ...
              const messageEmbed4 = new EmbedBuilder()
                .setColor(0xFF0000)
                .setTitle('Anti Toxicity setup complete.')
        ...
        case "disable":
          const errornodata = new EmbedBuilder()
            .setColor(0xFF0000)
            .setTitle('Anti Toxicity can not be disabled.')
          ...
          DB.findOne({ Guild: interaction.guild.id }, async (err, data) => {
            if (!data) {
              ...
              const messageEmbed5 = new EmbedBuilder()
                ...
                .setDescription(`All of the setup progress will be lost and AntiSystem will no longer delete messages deemed toxic.`)

              const row5 = new ActionRowBuilder()
                .addComponents(
                  new ButtonBuilder()
                    .setCustomId('continue_anti_toxicity')
                    .setLabel('Continue')
              ...
              const row_disabled_btn = new ActionRowBuilder()
                .addComponents(
                  new ButtonBuilder()
                    .setCustomId('continue_anti_toxicity_disabled')
                    .setLabel('Continue')
                    .setDisabled()
                    .setStyle(ButtonStyle.Danger),
                );
              ...
              collector.on('collect', async i => {
                if (i.user.id === interaction.user.id) {
                  ...
                  const messageEmbed6 = new EmbedBuilder()
                    .setColor(0xFF0000)
                    .setTitle(`Anti Toxicity has been disabled.`)
